    ...
    return (function (e) {
                                ...
                                value: function () {
                                    ...
                                    $(document)
                                        ...
                                        $(t.elem).bind("keyup", function (t) {
                                            var o = $(this),
                                                r = !1;
                                            (8 === t.keyCode || (t.keyCode < 105 && t.keyCode > 96) || (t.keyCode < 58 && t.keyCode > 47) || (a && (86 == t.keyCode || $.inArray(t.keyCode, s) > 0))) && (r = !0),
                                                r &&
                                                    (clearTimeout(i),
                                            ...
                                            ? ((t = 12),
                                              (i =
                                                  "PM" == this.model.state.view.meridian
                                                      ? this.model.PersianDate.date(this.model.state.selected.unixDate).add("hour", t).valueOf()
                                                      : this.model.PersianDate.date(this.model.state.selected.unixDate).subtract("hour", t).valueOf()),
                                              this.model.state.meridianToggle())
                                            : ((t = this.model.options.timePicker[e].step), (i = this.model.PersianDate.date(this.model.state.selected.unixDate).add(e, t).valueOf())),
                                            ...
                                            ? ((t = 12),
                                              (i =
                                                  "AM" == this.model.state.view.meridian
                                                      ...
                                                      : this.model.PersianDate.date(this.model.state.selected.unixDate).subtract("hour", t).valueOf()),
                                              this.model.state.meridianToggle())
                                            : ((t = this.model.options.timePicker[e].step), (i = this.model.PersianDate.date(this.model.state.selected.unixDate).subtract(e, t).valueOf())),
                                            this.model.state.setViewDateTime("unix", i),
                                            this.model.state.setSelectedDateTime("unix", i),
                                            this.model.view.renderTimePartial(),
                                            clearTimeout(this.scrollDelayTimeDown),
                                    ...
                                    this.model.options.navigator.enabled &&
                                        $(document).on("click", "#" + e.model.view.id + " .pwt-btn", function () {
                                            $(this).is(".pwt-btn-next")
                                                ? (e.model.state.navigate("next"), e.model.view.render(), e.model.options.navigator.onNext(e.model))
                                                : $(this).is(".pwt-btn-switch")
                                                ? (e.model.state.switchViewMode(), e.model.view.render(), e.model.options.navigator.onSwitch(e.model))
                                                : $(this).is(".pwt-btn-prev") && (e.model.state.navigate("prev"), e.model.view.render(), e.model.options.navigator.onPrev(e.model));
                                        }),
                                        this.model.options.timePicker.enabled &&
                                        ...
                                        this.model.options.dayPicker.enabled &&
                                            $(document).on("click", "#" + e.model.view.id + " .datepicker-day-view td:not(.disabled)", function () {
                                        ...
                                        this.model.options.monthPicker.enabled &&
                                            $(document).on("click", "#" + e.model.view.id + " .datepicker-month-view .month-item:not(.month-item-disable)", function () {
                                                var t = $(this).data("month"),
                                                    i = $(this).data("year");
                                                e.model.state.switchViewModeTo("day"),
                                                    e.model.options.onlySelectOnDate ||
                                                        (e.model.state.setSelectedDateTime("year", i), e.model.state.setSelectedDateTime("month", t), e.model.options.autoClose && (e.model.view.hide(), e.model.options.onHide(e))),
                                        ...
                                        this.model.options.yearPicker.enabled &&
                                            $(document).on("click", "#" + e.model.view.id + " .datepicker-year-view .year-item:not(.year-item-disable)", function () {
                                                var t = $(this).data("year");
                                                e.model.state.switchViewModeTo("month"),
                                                    e.model.options.onlySelectOnDate || (e.model.state.setSelectedDateTime("year", t), e.model.options.autoClose && (e.model.view.hide(), e.model.options.onHide(e))),
                        ...
                        a(e, [
                            {
                                ...
                                value: function (e) {
                                    e.inline && (e.toolbox.submitButton.enabled = !1),
                                        ...
                                        e.onlyTimePicker && ((e.dayPicker.enabled = !1), (e.monthPicker.enabled = !1), (e.yearPicker.enabled = !1), (e.navigator.enabled = !1), (e.toolbox.enabled = !1), (e.timePicker.enabled = !0)),
                        ...
                        a(e, [
                            {
                                ...
                                value: function (e) {
                                    ...
                                    return (
                                        ...
                                        (e = e.toEnglishDigits()),
                                        n.test(e) ? e.split(/\/|-|\,|\./).map(Number) : i.test(e) ? e.split(/\/|-|\,|\:|\T|\Z/g).map(Number) : void 0
                                    );
                                },
                            },
                        ]),
                        ...
                        a(e, [
                            {
                                ...
                                value: function (e) {
                                    ...
                                    return (
                                        ...
                                        this.model.options.calendar[this.model.options.calendarType].leapYearMode && n.toLeapYearMode(this.model.options.calendar[this.model.options.calendarType].leapYearMode),
                                        (i = new n(e)),
                ...
                o = (function () {
                    function e(t) {
                        return (
                            ...
                            (this.viewMode = this.viewModeList.indexOf(t.options.viewMode) > 0 ? t.options.viewMode : this.viewModeList[0]),
                            (this.viewModeIndex = this.viewModeList.indexOf(t.options.viewMode) > 0 ? this.viewModeList.indexOf(t.options.viewMode) : 0),
                            (this.filterDate = { start: { year: 0, month: 0, date: 0, hour: 0, minute: 0, second: 0, unixDate: 0 }, end: { year: 0, month: 0, date: 0, hour: 0, minute: 0, second: 0, unixDate: 0 } }),
                            (this.view = { year: 0, month: 0, date: 0, hour: 0, minute: 0, second: 0, unixDate: 0, dateObject: null, meridian: "AM" }),
                            (this.selected = { year: 0, month: 0, date: 0, hour: 0, hour12: 0, minute: 0, second: 0, unixDate: 0, dateObject: null }),
                        ...
                        a(e, [
                            {
                                ...
                                value: function () {
                                    ...
                                    "persian" == e.model.options.calendar_
                                        ? ((e.model.options.calendar_ = "gregorian"), (e.model.options.locale_ = this.model.options.calendar.gregorian.locale))
                                        : ((e.model.options.calendar_ = "persian"), (e.model.options.locale_ = this.model.options.calendar.persian.locale));
                                },
                            },
                            {
                                key: "_attachEvents",
                    ...
                    function e(t) {
                        ...
                        return (
                            this.model.state.ui.isInline
                                ? (this.$container = $('<div  id="' + this.id + '" class="datepicker-container-inline"></div>').appendTo(i.model.inputElement))
                                : ((this.$container = $('<div  id="' + this.id + '" class="datepicker-container"></div>').appendTo("body")), this.hide(), this.setPickerBoxPosition(), this.addCompatibilityClass()),
                            this
                        );
                    }
                    return (
                        s(e, [
                            ...
                            },
                            {
                                ...
                                value: function () {
                                    ...
                                    "auto" === this.model.options.position
                                        ...
                                        : this.$container.css({ left: this.model.options.position[1] + e.left + "px", top: this.model.options.position[0] + e.top + "px" });
                                },
                            },
                            {
                                key: "show",
                                ...
                                value: function (e) {
                                    ...
                                    return (
                                        "day" == this.model.state.viewMode
                                            ...
                                            ? (t = this.model.options.monthPicker.titleFormatter.call(this, e.dateObject.valueOf()))
                                            : "year" == this.model.state.viewMode && (t = this.model.options.yearPicker.titleFormatter.call(this, e.year)),
                                        t
                                    );
                                },
                            },
                                ...
                                value: function (e) {
                                    ...
                                    if (((t.minDate = this.model.options.minDate), (t.maxDate = this.model.options.maxDate), t.model.state.filetredDate))
                                        if (t.minDate && t.maxDate) {
                                            if (((t.minDate = t.model.PersianDate.date(t.minDate).startOf("day").valueOf()), (t.maxDate = t.model.PersianDate.date(t.maxDate).endOf("day").valueOf()), !(e >= t.minDate && e <= t.maxDate)))
                                                return !1;
                                        } else if (t.minDate) {
                                                ...
                                                for (var x, P = b.entries()[Symbol.iterator](); !(k = (x = P.next()).done); k = !0) {
                                                    ...
                                                    0 === y && M < s
                                                        ? ((S = this.model.state.view.dateObject
                                                          ...
                                                          (O = !0))
                                                        : (0 === y && M >= s) || (y <= 5 && l < a)
                                                        ? ((l += 1), (S = new persianDate([this.model.state.view.year, this.model.state.view.month, l])), (O = !1))
                                                        : ((d += 1), (S = this.model.state.view.dateObject.endOf("month").hour(12).add("days", d)), (O = !0)),
                                                        r[y].push({
                                                            title: S.format("D"),
                            ...
                            },
                            {
                                ...
                                value: function () {
                                    ...
                                    var t = void 0;
                                    return (
                                        (t = this.model.options.timePicker.meridian.enabled ? this.model.state.view.dateObject.format("hh") : this.model.state.view.dateObject.format("HH")),
                                        {
                                            enabled: e,
                                            hour: { title: t, enabled: this.model.options.timePicker.hour.enabled },
                                            minute: { title: this.model.state.view.dateObject.format("mm"), enabled: this.model.options.timePicker.minute.enabled },
                                            second: { title: this.model.state.view.dateObject.format("ss"), enabled: this.model.options.timePicker.second.enabled },
                                            meridian: { title: this.model.state.view.dateObject.format("a"), enabled: this.model.options.timePicker.meridian.enabled },
                                        }
                                    );
                                },
                            },
                            ...
                            },
                            {
                                ...
                                value: function (e) {
                                    ...
                                    return {
                                        plotId: "",
                                        navigator: { enabled: this.model.options.navigator.enabled, switch: { enabled: !0, text: this._getNavSwitchText(e) }, text: this.model.options.navigator.text },
                                ...
                                value: function () {
                                    ...
                                    return (
                                        "fa" == this.model.options.locale_
                                            ? ((e.todayButtontext = this.model.options.toolbox.todayButton.text.fa), (e.submitButtonText = this.model.options.toolbox.submitButton.text.fa))
                                            : "en" == this.model.options.locale_ && ((e.todayButtontext = this.model.options.toolbox.todayButton.text.en), (e.submitButtonText = this.model.options.toolbox.submitButton.text.en)),
                                        e
                                    );
                                },
                            },
        ...
        function (e, t, i) {
            !(function (t, i) {
                ...
                (n.normalise = {
                    browser: function () {
                        "onwheel" in i || i.documentMode >= 9 || (n.SUPPORT = void 0 !== i.onmousewheel ? "mousewheel" : "DOMMouseScroll"),
                            t.addEventListener || ((n.ADD_EVENT = "attachEvent"), (n.REMOVE_EVENT = "detachEvent"), (n.PREFIX = "on"));
                    },
                    event: function (e) {
                        var t = {
                            originalEvent: e,
                        ...
                        return e.wheelDelta && (t.deltaY = -0.025 * e.wheelDelta), e.wheelDeltaX && (t.deltaX = -0.025 * e.wheelDeltaX), e.detail && (t.deltaY = e.detail), t;
                    },
                    delta: function (e) {
                        var t,
                            i = 0,
                ...
                function d(t, i) {
                    ...
                    for (var y, b, T, M, S, O, E = new h(t); !E.eos(); ) {
                        ...
                        if (
                            ...
                            (b = E.scan(P) || "name"),
                            E.scan(k),
                            "=" === b ? ((T = E.scanUntil(D)), E.scan(D), E.scanUntil(s)) : "{" === b ? ((T = E.scanUntil(l)), E.scan(x), E.scanUntil(s), (b = "&")) : (T = E.scanUntil(s)),
                            !E.scan(s))
                        )
                ...
                (h.prototype.eos = function () {
                    ...
                    (m.prototype.lookup = function (e) {
                        ...
                        if (n.hasOwnProperty(e)) i = n[e];
                            ...
                            for (var s, r, l, d = this, c = !1; d; ) {
                                if (e.indexOf(".") > 0) for (s = d.view, r = e.split("."), l = 0; null != s && l < r.length; ) l === r.length - 1 && (c = a(s, r[l]) || o(s, r[l])), (s = s[r[l++]]);
                    ...
                    (v.prototype.renderSection = function (e, i, n, a) {
                        ...
                        var s = this,
                            ...
                            l = i.lookup(e[1]);
                        if (l) {
                            if (f(l)) for (var d = 0, c = l.length; d < c; ++d) r += this.renderTokens(e[4], i.push(l[d]), n, a);
